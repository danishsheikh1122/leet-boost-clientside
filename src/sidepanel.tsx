...
// const SidePanel = () => {
//   const [isDarkMode, setIsDarkMode] = useState(false);
//   const { isLoaded, user, isSignedIn, signOut } = useUser(); // Hook to check user status
...
//   if (!isLoaded) {
//     // Optionally handle the loading state, like showing a loader
...
//           <div>
//             <p className="text-sm leading-relaxed">
//               Welcome, {user?.firstName}! You're logged in.
//             </p>
//             <button 
//               onClick={() => signOut()} 
//               className="w-full bg-red-500 text-white py-3 rounded-lg font-semibold transition-colors duration-200 flex items-center justify-center space-x-2 focus:outline-none focus:ring-2 focus:ring-[#FFA116] focus:ring-opacity-50"
//             >
//               Sign Out
//             </button>
//           </div>
//         ) : (
//           <div>
//             <p className="text-sm leading-relaxed">Please sign in to access LeetBoost features.</p>
//             <SignIn />
//             <SignUp />
//           </div>
//         )}
